...
namespace MonoTouch.Dialog
{
	...
	public class Element : IDisposable {
		...
		/// <summary>
		/// Invoked when the given element's accessory has been tapped by the user.
		/// </summary>
		/// <param name="dvc">
		/// The <see cref="DialogViewController"/> where the selection took place
		/// </param>
	...
	public class EntryElement : Element {
		...
		{
			return new UITableViewCell (UITableViewCellStyle.Default, ekey);
		}
		...
		public override UITableViewCell GetCell (UITableView tv)
		{
			...
			entry.KeyboardAppearance = KeyboardAppearance;
	...
	public class DateWithRangeElement : DateElement 
	{
		public DateTime MinDate;
		public DateTime MaxDate;
		public DateWithRangeElement(string caption, DateTime date) : base(caption, date)
		{
		}
		
		public override UIDatePicker CreatePicker ()
		{
			UIDatePicker picker = base.CreatePicker ();
